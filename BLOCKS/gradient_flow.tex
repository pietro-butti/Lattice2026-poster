...
\begin{block}{A fully $\mathcal{O}(a^2)$-improved susceptibility}
    ...
    \item \textcolor{jgr}{\textbf{Action:}}
      ...
      \begin{equation*}
        S_\text{conf} = \frac{\beta}{3}\sum_x\qty(
            c_0\sum_{\mu<\nu} \real \tr \qty(1 - \vcenter{\hbox{\plaquette[0.7]}})
        +   c_1\sum_{\mu<\nu} \real \tr \qty(1 - \vcenter{\hbox{\cloverleaf[0.7]{2}{1}}})
        )
      \end{equation*}
      $\;\Rightarrow\;$ \emph{use improved actions!}
  ...
  $t_0$, tracks the $\mathcal{O}(a^2)$ ambiguity of the flow scale and is
